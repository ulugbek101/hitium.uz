...
class Review(BaseModel):
    ...
    video = models.FileField(verbose_name="Видео", help_text="Видео отзыв клиента (не больше 20 MB)", upload_to="videos/", null=True)
    ...
    def __str__(self):
        return f"{self.fullname} - {self.created.strftime('%d.%m.%Y %H:%M')}"
